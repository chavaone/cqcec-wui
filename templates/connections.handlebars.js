...
function program6(depth0,data) {
  ...
  buffer += "\n									("
    + escapeExpression(((stack1 = (depth0 && depth0.domain)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + ")\n									<a class=\"icon-pencil edit_button\" href=\"\"></a>\n								";
  return buffer;
  }
...
function program15(depth0,data) {
  ...
  buffer += "\n		<li id=\"conn"
    ...
    + escapeExpression(((stack1 = (depth0 && depth0.ip_dest)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</li>\n					<li class=\"domain\">\n						<span class=\"domain\">\n						";
  stack2 = helpers['if'].call(depth0, (depth0 && depth0.islocal), {hash:{},inverse:self.program(18, program18, data),fn:self.program(16, program16, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n					</li>\n				</ul>\n				";
  stack2 = helpers['if'].call(depth0, (depth0 && depth0.number), {hash:{},inverse:self.noop,fn:self.program(10, program10, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
...
function program18(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n							";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.domain), {hash:{},inverse:self.program(21, program21, data),fn:self.program(19, program19, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n							</span>\n							<a class=\"icon-pencil edit_button\" href=\"javascript:void(0)\" onclick=\"app.edit_domain_cache('"
    + escapeExpression(((stack1 = (depth0 && depth0.ip_dest)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "', '"
